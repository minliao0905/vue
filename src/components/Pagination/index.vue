<template>
  <div class="pagination">
    ...
    <button v-for="page in  startAndEndNum.end" :key="page" v-show="page>=startAndEndNum.start" :class="{active:pageNo==page}" @click="this.$emit('currentPage',page)">{{page}}</button>
